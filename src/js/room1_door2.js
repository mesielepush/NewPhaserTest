...
class room1_door2 extends Phaser.Scene {
  ...
  create() {
    this.soundOn = this.add.image(150, 150, 'soundOn').setScale(0.3).setVisible(false).setDepth(6);
    this.soundOff = this.add.image(150, 150, 'soundOff').setScale(0.3).setDepth(6);
